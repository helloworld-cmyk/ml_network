"""OCR ảnh trang PDF (từ folder _preview_pages) sang text bằng Ollama.

Usage:
  python core/script.py
  python core/script.py -o .md/output.txt
  python core/script.py --start-page 8
  python core/script.py --images-dir rawtext/_preview_pages --model glm-ocr
"""
...
def main() -> int:
	parser = argparse.ArgumentParser(
		description="OCR ảnh trang từ folder _preview_pages sang text bằng Ollama"
	)
	parser.add_argument(
		"--images-dir",
